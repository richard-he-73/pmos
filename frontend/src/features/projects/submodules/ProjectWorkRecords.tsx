...
const ProjectWorkRecords: React.FC = () => {
  ...
  const { data: workRecords = [], isLoading: loading, refetch } = useGetWorkRecordsQuery({ project_id: projectId });
    ...
    <div style={{ padding: '24px' }}>
      <div style={{ marginBottom: 24 }}>
        <Title level={4} style={{ margin: 0, display: 'inline' }}>
          <ClockCircleOutlined style={{ marginRight: 8, color: '#13c2c2' }} />
          工作管理（考勤/工时）
        </Title>
      </div>
...
export default ProjectWorkRecords;
